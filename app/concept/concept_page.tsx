  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 pb-24">
        ...
        {/* Page header */}
        <div className="mb-10 pb-8 border-b border-zinc-100 concept-fade-in concept-fade-in-1">
        ...
        {/* ── Empty state ───────────────────────────────────────────────────── */}
        {!concept && (
          <div className="bg-white rounded-xl border border-zinc-200 shadow-sm px-10 py-20 text-center concept-fade-in concept-fade-in-2">
            ...
            <button
              onClick={generate}
              disabled={generating}
              className="text-sm font-semibold text-white bg-green-600 hover:bg-green-700 disabled:bg-zinc-300 transition-colors duration-150 rounded-lg px-5 py-2.5 active:scale-[0.98]"
            >
        ...
        {concept && (
          <div className="flex flex-col gap-5">
            ...
            {kpiItems.length > 0 && (
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {kpiItems.map(({ label, val, sub, Icon }, i) => (
                  <div
                    key={label}
                    className={`bg-white border border-zinc-200 rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow duration-200 concept-fade-in concept-fade-in-${(i + 1) as 1 | 2 | 3}`}
                  >
            ...
            {/* Ist → Ziel */}
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm overflow-hidden concept-section">
